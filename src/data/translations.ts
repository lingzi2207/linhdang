...
export const NAV_PAGES: PageInfo[] = [
  ...
  {
    id: 'du-an',
    label: { vi: 'Dự án tiêu biểu', en: 'Featured Works' },
    shortLabel: { vi: 'Dự án tiêu biểu', en: 'Projects' },
    pageNum: '02',
  },
  {
    id: 'gioi-thieu',
...
export const UI_TEXT = {
  vi: {
    ...
    about: {
      ...
      workingLanguagesVal: 'Tiếng Việt (Bản ngữ) · Tiếng Anh · Tiếng Pháp',
      expertiseLabel: 'CHUYÊN MÔN NỔI BẬT',
      expertiseVal: 'Văn học dịch, Khảo cứu Triết học, Nghệ thuật in',
    ...
    contact: {
      ...
      workLocationDesc: 'Linh hoạt trao đổi trực tiếp tại Hà Nội, TP. Hồ Chí Minh và làm việc từ xa cùng các đối tác toàn cầu.',
    },
    footer: {
      ...
      personalPositioningDesc: 'Hà Nội & TP. Hồ Chí Minh\nChuyên trách: Sách dịch, Triết học, Mỹ thuật sách',
      fastNavTitle: 'ĐIỀU HƯỚNG NHANH',
      navHome: 'Trang chủ',
      navProjects: 'Các dự án tiêu biểu',
  ...
  en: {
    ...
    about: {
      ...
      workingLanguagesVal: 'Vietnamese (Native) · English · French',
      expertiseLabel: 'CORE SPECIALIZATIONS',
      expertiseVal: 'Translated Fiction, Scholarly Philosophy, Fine Typography',
    ...
    contact: {
      ...
      workLocationDesc: 'Readily available for in-person meetings in Hanoi and Ho Chi Minh City, as well as worldwide remote collaboration.',
    },
    footer: {
      ...
      personalPositioningDesc: 'Hanoi & Ho Chi Minh City\nFocus: Translated Books, Philosophy, Fine Book Arts',
